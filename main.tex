...
\begin{frame}
\frametitle{Improving Reference Resolution}
\begin{itemize}
    \item Resolving multiple dots
        \begin{itemize}
        \item Likely not enough data
        \item Gather more data with more ambiguity, i.e. dots
            all have the same size and color? Would this transfer?
        \end{itemize}
    \item Architectures that are more biased towards composition
        ...
        \end{itemize}
    \item Reasoning explicitly about past references
        \begin{itemize}
